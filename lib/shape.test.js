...
describe('Circle', () => {
    ...
    it('should handle invalid text length', async () => {
        ...
        jest.spyOn(inquirer, 'prompt').mockResolvedValue(shapeOptions);

        await main();

        expect(consoleSpy).toHaveBeenCalledWith('Please enter no more than three characters!');
        consoleSpy.mockRestore();
    });

    it('should handle invalid text color', async () => {
        const consoleSpy = jest.spyOn(console, 'log').mockImplementation();
        const shapeOptions = {
            text: 'ABC', 
            textColor: 'blaaack',
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Please enter a valid text color!');
        consoleSpy.mockRestore();
    });
    ...
    it('should handle invalid color', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Please enter a valid color!');
        consoleSpy.mockRestore();
    });
    ...
    it('should handle invalid background color', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('Please enter a valid background color!');
        consoleSpy.mockRestore();
    });
});
